          ...
          <div className="glass-panel p-8 md:p-12 border border-brand-emerald/30 shadow-[0_0_50px_rgba(1,228,126,0.08)] rounded-3xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-wider text-white leading-tight">
              ...
              {/* RIGHT COLUMN — Instruction Steps */}
              <div className="space-y-5">
                {/* Divider visible only on mobile */}
                <div className="h-px bg-white/10 md:hidden"></div>

                <h3 className="text-xs font-mono uppercase tracking-widest text-[#00D1FF] font-bold text-center md:text-left">

    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Activación del Observador", time: "10 min", inst: "Respiración 4-7-8 (inhala 4s, sostén 7s, exhala 8s) × 4 ciclos. Luego solo observa qué pensamientos surgen. Los que te incomodan son exactamente lo que tu Saboteador no quiere que veas." },
      ...
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Activación del Observador", time: "10 min", inst: "Respiración 4-7-8 × 4 ciclos. Observa los pensamientos sobre tu trading que surgen sin invitarlos. Los que te incomodan son la firma directa de tu Saboteador." },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Respiración Anti-Sabotaje", time: "8 min", inst: "Técnica 5-5-7: inhala 5s, sostén 5s, exhala 7s × 6 ciclos. Con cada exhale di internamente: 'Te veo. No te necesito ahora.' Memoriza esta técnica — la usarás los próximos 7 días." },
          ...
          { type: "reflection", icon: "🔍", title: "La Necesidad Secreta", time: "10 min", inst: "El autosabotaje no ocurre de la nada: tu Saboteador intenta 'protegerte' de algo, aunque lo haga de forma equivocada. Escribe o selecciona cuál crees que es su misión secreta principal: 1) Protegerme del fracaso (si no lo intento, no fracaso). 2) Confirmar que 'no merezco abundancia' (por culpa o creencias familiares/pasadas). 3) Mantener la zona de confort (miedo a lo desconocido). 4) Evitar el juicio o críticas de otros. 5) Castigarme por errores del pasado. La opción que elijas representa su lealtad invisible y es tu mayor punto ciego." },
        ],
      },
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Respiración Anti-Sabotaje", time: "8 min", inst: "Técnica 5-5-7 × 6 ciclos. Con cada exhale: 'Te veo. No te necesito ahora.' Esta es tu primera arma defensiva entre trades. Memorízala." },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Visualización: Cuenta al Doble", time: "12 min", inst: "Coherencia cardíaca: 5s inhala, 5s exhala × 10. Visualiza que tienes EXACTAMENTE el doble de dinero. Observa qué emoción surge. ¿Alegría? ¿Culpa? ¿Miedo? Lo que sientas ES tu Saboteador financiero." },
      ...
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Visualización: Cuenta al Doble", time: "12 min", inst: "Coherencia cardíaca × 10. Visualiza tu cuenta con el DOBLE de capital. ¿Operarías diferente? ¿Sientes que 'no es tuyo'? Esa resistencia ES sombra financiera operando contra ti." },
  ...
  // ═══ DAY 5 ═══
  {
    ...
    routes: {
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Diálogo con tu Saboteador Trader", time: "25 min", inst: "YO: '¿Por qué me saboteas en mis mejores setups?' SABOTEADOR: (responde sin censura). 2+ páginas. '¿Qué necesitas?', '¿Qué me proteges de ver?', '¿Cuándo te instalaste?'. Las respuestas te van a sorprender." },
          ...
          { type: "practice", icon: "📊", title: "Pre-Trade Check Obligatorio", time: "Durante tu sesión", inst: "Antes de CADA trade hoy: '¿Es mi análisis o es mi Saboteador?'. Si más de la mitad son 'Saboteador', PARA la sesión. Salvaste tu cuenta." },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Ritual de Mañana Integrado", time: "10 min", inst: "Tu nuevo ritual: 1) Respiración 4-7-8 × 3. 2) '¿Cómo está mi Saboteador hoy?' 3) '¿Mi máscara está rígida?' 4) Intención: 'Hoy actúo desde mi totalidad'. Practica HOY." },
          { type: "practice", icon: "🎯", title: "Un Día Integrado", time: "Durante el día", inst: "Cada decisión la tomas con doble check: ¿es mi yo racional? ¿es mi Saboteador? ¿o es mi totalidad? Anota cuántas fueron de cada tipo. Tu objetivo: que la mayoría sean integradas." },
      ...
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Ritual Pre-Trading Integrado", time: "10 min", inst: "1) Respiración 4-7-8 × 3. 2) '¿Cómo está mi Saboteador?' 3) '¿Mi persona trader está rígida?' 4) 'Hoy opero desde la totalidad'. 5) Abre plataforma. Repite cada sesión." },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Ceremonia de Cierre", time: "15 min", inst: "Respiración 4-7-8 × 5. Visualiza a tu Saboteador frente a ti. Ya no es enemigo — es aliado contratado. Extiende la mano. Di en voz alta: 'Somos uno. Actúo desde mi totalidad'." },
      ...
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Ceremonia de Cierre", time: "15 min", inst: "Respiración 4-7-8 × 5. Visualiza a tu Saboteador trader. Extiende la mano: 'Somos uno. Operamos desde la totalidad'. Abre los ojos como un trader integrado." },

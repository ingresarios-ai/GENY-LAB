  ...
  // ═══ DAY 2 ═══
  {
    ...
    routes: {
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Trader Ideal vs Trader Real", time: "20 min", inst: "Toma una hoja y divídela en 2 columnas:\n\nCOLUMNA IZQUIERDA — 'El trader que pretendo ser':\nDescribe cómo te imaginas operando en tu mejor momento (disciplinado, paciente, frío, sin emociones). Escribe al menos 5 características.\n\nCOLUMNA DERECHA — 'El trader que aparece después de 3 pérdidas seguidas':\nDescribe con honestidad brutal cómo reaccionas realmente cuando las cosas salen mal (impulsivo, vengativo, asustado, desesperado). Escribe al menos 5 características.\n\nCompara ambas columnas: la distancia entre las dos es el tamaño exacto de tu Saboteador. Ese segundo trader de la derecha es a quien vas a vencer en los próximos 8 días." },
          ...
          { type: "practice", icon: "📊", title: "Estado en Tiempo Real", time: "Durante tu sesión", inst: "Este ejercicio se hace durante tu sesión de trading. El objetivo es registrar tu estado emocional en 3 momentos clave para detectar cómo tu Saboteador se activa con las ganancias y pérdidas.\n\nPaso 1 — ANTES de abrir los charts:\nEscribe en tu cuaderno: 'Me siento ___ porque ___'.\nEjemplo: 'Me siento ansioso porque ayer perdí y quiero recuperar'.\n\nPaso 2 — DESPUÉS de cada trade (ganador o perdedor):\nRepite: 'Me siento ___ porque ___'.\nEjemplo: 'Me siento eufórico porque acabo de ganar y quiero meter otro trade'.\n\nPaso 3 — AL CERRAR la sesión:\nÚltimo registro: 'Me siento ___ porque ___'.\n\nMínimo 5 registros en total durante el día.\n\nAl finalizar, revisa tus registros: observa cómo tu estado emocional sube y baja según tus ganancias y pérdidas (P&L). Esa fluctuación emocional es tu Saboteador respirando — y ahora puedes verlo en datos." },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "practice", icon: "🎯", title: "Mapa de Triggers", time: "15 min", inst: "Dibuja 3 columnas en una hoja:\n\n1. DETONANTE: El evento o estímulo que activa tu sabotaje.\n2. REACCIÓN: Qué haces o dejas de hacer inmediatamente.\n3. NECESIDAD OCULTA: El miedo o creencia detrás de tu reacción.\n\nEjemplo: 'Veo un curso nuevo (Detonante) → Lo ignoro o pospongo (Reacción) → Miedo a descubrir que no soy tan inteligente o capaz (Necesidad oculta)'.\n\nIdentifica y escribe 5 detonantes (triggers) en tus finanzas o estudio." },
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Ficha Policial del Saboteador", time: "20 min", inst: "Vas a crear una ficha detallada de tu Saboteador interno como si fuera un criminal que necesitas identificar. Llena cada campo en tu cuaderno:\n\n1. NOMBRE: Ponle un nombre a tu Saboteador (puede ser inventado o un apodo que represente su personalidad). Ejemplo: 'El Vengador', 'El Impaciente', 'El Cobarde'.\n\n2. VOZ: ¿Qué frases te dice cuando aparece? Escribe al menos 3.\nEjemplo: 'Recupera eso YA', 'Un trade más y ya', 'Esta vez es diferente', 'Si no entras ahora vas a perder la oportunidad'.\n\n3. MODUS OPERANDI: Describe su patrón de ataque respondiendo:\n• ¿Después de cuántas pérdidas seguidas se activa? (Ej: después de 2 pérdidas)\n• ¿En qué horario del día es más peligroso? (Ej: al final de la sesión)\n• ¿Qué tipo de trade te hace tomar? (Ej: entradas sin setup, posiciones más grandes)\n• ¿Qué excusa usa para justificarse? (Ej: 'Solo es un scalp rápido')\n\nLo que no puedes nombrar te sigue dominando. Esta ficha es tu primera herramienta de defensa." },
          ...
          { type: "practice", icon: "📊", title: "Protocolo Pausa Obligatoria", time: "Durante tu sesión", inst: "Este ejercicio se aplica durante tu sesión de trading de hoy. Es una regla obligatoria que debes seguir al pie de la letra:\n\nLA REGLA: Después de CUALQUIER trade perdedor, cierra tu plataforma y espera 15 minutos antes de volver a operar. Sin excepciones.\n\nDurante esos 15 minutos haz lo siguiente:\n1. Levántate de tu silla y aléjate de la pantalla.\n2. Escribe en tu cuaderno: '¿Qué quiere hacer mi Saboteador AHORA MISMO?' (Ej: 'Quiere que entre inmediatamente para recuperar lo perdido').\n3. Escribe: '¿Por qué NO se lo voy a permitir?' (Ej: 'Porque sé que el revenge trading me ha costado más que la pérdida original').\n4. Regresa a tu estación solo cuando los 15 minutos hayan pasado.\n\nSi logras cumplir esta pausa cada vez que pierdas hoy, le habrás ganado una batalla real a tu Saboteador. Cada pausa respetada fortalece tu disciplina." },
          { type: "reflection", icon: "🔍", title: "Los 5 Por Qué del Sabotaje", time: "10 min", inst: "Este ejercicio usa la técnica de los '5 Por Qué' para llegar a la raíz profunda de tu autosabotaje. Es simple pero poderoso.\n\nPaso 1: Identifica tu peor patrón de trading (el error que más repites). Ejemplo: 'Muevo mi stop loss cuando el precio se acerca'.\n\nPaso 2: Pregúntate '¿Por qué lo hago?' y responde. Luego pregunta '¿Por qué?' sobre esa respuesta. Repite 5 veces en cadena:\n\nEjemplo completo:\n• ¿Por qué muevo el stop? → Porque no quiero que me saque con pérdida.\n• ¿Por qué no quiero la pérdida? → Porque confirmar la pérdida me hace sentir tonto.\n• ¿Por qué me siento tonto? → Porque debí haberlo visto venir.\n• ¿Por qué necesito verlo todo? → Porque si fallo, mi padre tenía razón sobre mí.\n• ¿Por qué importa lo que dijo mi padre? → Porque en el fondo creo que soy un fracaso.\n\nLa 5ª respuesta es tu MIEDO NUCLEAR: la creencia profunda que tu Saboteador protege. Escríbela y ponla donde la veas. Nombrarla le quita el 50% de su poder sobre ti." },
        ],
      },
    },
  },
  // ═══ DAY 4 ═══
  {
    ...
    routes: {
      novato: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Arqueología Financiera", time: "25 min", inst: "Responde en tu diario:\n\n1. ¿Qué frases sobre dinero escuchabas en casa?\n2. ¿Tu familia era de 'nunca hay' o 'el dinero no importa'?\n3. ¿Cuál es tu PRIMER recuerdo emocional con dinero?\n4. ¿Qué sientes cuando alguien de tu edad gana mucho?\n5. ¿Realmente CREES que mereces abundancia?" },
          { type: "meditation", icon: "🧘", title: "Visualización: Cuenta al Doble", time: "12 min", inst: "CIERRA LOS OJOS y regula tus pulsaciones aplicando coherencia cardíaca:\n1. Inhala suave y profundamente por la nariz durante 5 segundos.\n2. Exhala lento por la boca durante 5 segundos.\nRepite este ritmo constante por 10 ciclos.\n\nAl terminar, VISUALIZA en tu mente que tienes EXACTAMENTE el doble de dinero en tu cuenta bancaria. OBSERVA qué emoción surge en tu cuerpo: ¿Alegría? ¿Culpa? ¿Miedo? ¿Incredulidad?\n\nESCRIBE en tu cuaderno qué sentiste al imaginarlo. La emoción que más te incomodó es exactamente lo que tu Saboteador financiero usa para mantenerte donde estás." },
          { type: "practice", icon: "🎯", title: "Score de Creencias Limitantes", time: "15 min", inst: "Califica de 1 a 10 qué tan VERDADERAS sientes las siguientes afirmaciones:\n\n• \"Ganar mucho es egoísta\" (___/10)\n• \"Si gano mucho, algo malo pasará\" (___/10)\n• \"Yo no soy de los que tienen dinero\" (___/10)\n• \"El dinero cambia a la gente\" (___/10)\n\nLas afirmaciones con un puntaje mayor a 6 representan tus sombras activas." },
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Arqueología Financiera Trader", time: "25 min", inst: "Responde en tu diario:\n\n1. ¿Qué frases sobre dinero escuchabas en casa?\n2. ¿Cuánto SIENTES que mereces ganar al mes? ¿Quién definió ese número?\n3. ¿Qué sientes cuando ganas $5K en un día? ¿Y cuando pierdes $5K?\n4. ¿Mereces ganar más que tus padres?\n5. ¿Tu sizing es pequeño 'por seguridad' o porque NO mereces arriesgar más?" },
          { type: "meditation", icon: "🧘", title: "Visualización: Cuenta al Doble", time: "12 min", inst: "CIERRA LOS OJOS y regula tus pulsaciones aplicando coherencia cardíaca:\n1. Inhala suave y profundamente por la nariz durante 5 segundos.\n2. Exhala lento por la boca durante 5 segundos.\nRepite este ritmo constante por 10 ciclos.\n\nAl terminar, VISUALIZA en tu mente tu cuenta de trading con el DOBLE de capital que tienes ahora. OBSERVA qué emociones surgen en tu cuerpo: ¿Operarías diferente? ¿Sientes resistencia, incomodidad o que ese dinero 'no te pertenece'?\n\nESCRIBE en tu cuaderno qué sentiste al imaginarlo. Esa tensión es la firma de tu sombra financiera — una creencia inconsciente que limita cuánto te permites ganar." },
          { type: "practice", icon: "📊", title: "Auditoría Forense de Sizing", time: "15 min", inst: "ABRE tu historial de trades de las últimas 2 semanas y ESCRIBE en tu cuaderno una tabla con estas 3 columnas para cada trade:\n\n1. TRADE: Par/activo y dirección (ej: EUR/USD Long).\n2. TAMAÑO: Lotaje o cantidad de contratos que usaste.\n3. RESULTADO: ¿Fue ganador o perdedor?\n\nAl terminar, OBSERVA los patrones y RESPONDE estas preguntas:\n• ¿Tu tamaño de posición es consistente o cambia según si vienes de ganar o perder?\n• ¿Operas demasiado pequeño después de pérdidas? (señal de miedo)\n• ¿Operas demasiado grande después de ganancias? (señal de codicia/euforia)\n\nCada inconsistencia en tu sizing es una huella directa de tu Saboteador actuando sin que lo notes." },
          { type: "reflection", icon: "🔍", title: "Carta al Dinero", time: "10 min", inst: "ESCRIBE una carta dirigida al dinero como si fuera una persona con la que tienes una relación. Empieza con 'Querido Dinero:' y responde estas preguntas en tu carta:\n\n• ¿Qué tipo de relación tenemos? ¿De confianza, de miedo, de amor-odio?\n• ¿Te persigo desesperadamente o te ahuyento inconscientemente?\n• ¿Qué siento cuando llegas? ¿Y cuando te vas?\n• ¿Qué me gustaría cambiar de nuestra relación?\n\nEscribe al menos media página. Lo que descubras en esta carta revela cómo tu inconsciente maneja cada decisión financiera que tomas." },
        ],
      },
    },
  },
    ...
    routes: {
      ...
      operador: {
        ...
        exercises: [
          ...
          { type: "meditation", icon: "🧘", title: "Encuentro en tu Estación", time: "15 min", inst: "CIERRA LOS OJOS y VISUALIZA tu estación de trading con todos sus detalles (pantallas, silla, teclado). Ahora OBSERVA: hay alguien sentado en TU silla operando. Es tu Saboteador.\n\nOBSERVA cómo opera y RESPONDE mentalmente:\n• ¿Qué trades está tomando? ¿Son impulsivos o calculados?\n• ¿Cómo gestiona el riesgo? ¿Mueve stops? ¿Sobreopera?\n• ¿Qué expresión tiene en la cara? ¿Está ansioso, enojado, eufórico?\n\nAhora PREGÚNTALE en voz alta o mentalmente: '¿Por qué operas así? ¿Qué buscas realmente?'\n\nESCUCHA la respuesta sin juzgarla. Al terminar, ESCRIBE en tu cuaderno lo que te dijo y lo que observaste. Esta visualización te permite ver desde afuera los patrones que repites sin darte cuenta." },
          { type: "practice", icon: "📊", title: "Filtro Pre-Operación Obligatorio", time: "Durante tu sesión", inst: "Este ejercicio se aplica durante tu sesión de trading de hoy. ANTES de colocar cada operación (trade), DETENTE y realiza esta validación obligatoria:\n\nPaso 1 — PREGÚNTATE en voz alta: '¿Esta entrada viene de mi análisis técnico o es impulsada por mi Saboteador?'\n\nPaso 2 — ESCRIBE en tu cuaderno junto a cada trade:\n• ✅ ANÁLISIS: si la entrada está justificada por tu plan y setup.\n• ⚠️ SABOTEADOR: si sientes que es impulso, venganza o FOMO.\n\nPaso 3 — EVALÚA al final de la sesión: cuenta cuántos trades fueron de análisis vs Saboteador.\n\nREGLA DE PROTECCIÓN: Si notas que más de la mitad de tus intenciones de entrada son generadas por el Saboteador, DETÉN la sesión inmediatamente por hoy para proteger tu cuenta. Operar desde el Saboteador es apostar, no hacer trading." },
  ...
  // ═══ DAY 6 ═══
  {
    ...
    routes: {
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Los 5 Por Qué del Trader", time: "20 min", inst: "ESCRIBE en tu cuaderno tu peor patrón de trading (el error que más repites). Luego aplica la técnica de los 5 Por Qué escribiendo una cadena de preguntas y respuestas:\n\nPaso 1 — ESCRIBE: '¿Por qué hago [tu patrón]?' y responde con honestidad.\nPaso 2 — ESCRIBE: '¿Por qué [tu respuesta anterior]?' y responde de nuevo.\nRepite hasta completar 5 niveles.\n\nEjemplo:\n• ¿Por qué muevo el stop? → Porque no quiero confirmar la pérdida.\n• ¿Por qué no quiero confirmarla? → Porque perder me hace sentir tonto.\n• ¿Por qué me siento tonto? → Porque debería haberlo visto venir.\n• ¿Por qué necesito verlo todo? → Porque mi padre me llamaba tonto cuando fallaba.\n• ¿Por qué importa eso aún? → Porque en el fondo creo que soy un fracaso.\n\nLa 5ª respuesta es tu MIEDO NUCLEAR. ESCRÍBELA en grande y pégala cerca de tu estación de trading. Nombrarla le quita el 50% de su poder." },
          { type: "meditation", icon: "🧘", title: "Exposición Controlada", time: "12 min", inst: "Este es un ejercicio de introspección guiada. El objetivo es exponerte a tu miedo más grande de manera controlada para reducir su poder emocional sobre ti.\n\nPaso 1 — CIERRA LOS OJOS y VISUALIZA la PEOR sesión de trading posible: pérdidas consecutivas, el mercado moviéndose en tu contra, tu cuenta en rojo.\n\nPaso 2 — PERMITE que las emociones surjan sin resistirlas: vergüenza, rabia, impotencia, miedo. No huyas de ellas ni intentes calmarlas todavía.\n\nPaso 3 — RESPIRA con ritmo 5/7 (inhala 5 segundos, exhala 7 segundos) mientras mantienes la imagen. Continúa respirando así por 5 minutos completos.\n\nPaso 4 — Al terminar, REPITE en voz alta: 'Puedo sentir todo esto y seguir operando mañana con disciplina.'\n\nESCRIBE en tu cuaderno qué emociones aparecieron y qué tan intensas fueron (1-10). Este ejercicio entrena a tu cerebro para tolerar el dolor sin reaccionar impulsivamente." },
          { type: "practice", icon: "📊", title: "Operar CON el Miedo Presente", time: "Durante tu sesión", inst: "Este ejercicio se practica durante tu sesión de trading de hoy. NO intentes eliminar el miedo — apréndelo a usar como información.\n\nCada vez que sientas miedo ANTES de tomar un trade, DETENTE y haz lo siguiente:\n\nPaso 1 — RECONOCE: Di en voz baja o mentalmente: 'Te siento, miedo. Estás aquí.'\n\nPaso 2 — ANALIZA: Pregúntate: '¿Este miedo es REAL (hay un riesgo técnico legítimo que no he visto) o es mi HERIDA emocional reaccionando?'\n\nPaso 3 — DECIDE:\n• Si el miedo es REAL → AJUSTA tu riesgo o no entres. El miedo te está protegiendo.\n• Si el miedo es tu HERIDA → Opera según tu plan original SIN modificar nada. No dejes que el niño asustado tome decisiones de adulto.\n\nPaso 4 — ESCRIBE después de cada trade: '¿El miedo era real o herida? ¿Decidí bien?'\n\nAl finalizar la sesión, REVISA tus notas y OBSERVA cuántas veces el miedo era real vs cuántas era solo tu Saboteador." },
          { type: "reflection", icon: "🔍", title: "Carta al Miedo", time: "10 min", inst: "ESCRIBE una carta dirigida a tu miedo nuclear (el que descubriste en el ejercicio de los 5 Por Qué). Usa esta estructura como guía:\n\n'Querido [nombre de tu miedo]:\n\nSé que existes desde [escribe cuándo crees que apareció por primera vez en tu vida].\nSé que tratas de protegerme de [escribe de qué crees que te protege].\nPero yo ya no soy ese niño/a.\nEn esta silla, YO decido. Tú observas.\nYa no necesito tu protección para operar.'\n\nAl terminar, LEE la carta EN VOZ ALTA. Guárdala y léela antes de cada sesión de trading durante los próximos días. Cada vez que la leas, tu miedo pierde un poco más de poder." },
        ],
      },
    },
  },
  // ═══ DAY 7 ═══
  {
    ...
    routes: {
      novato: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Inventario de Dones Reprimidos", time: "20 min", inst: "Responde en tu diario:\n\n1. ¿Qué talentos te han elogiado que tú minimizas?\n2. ¿Qué harías si NADIE pudiera juzgarte?\n3. ¿A quién envidias en silencio? (la envidia señala tu propio potencial dormido).\n4. ¿Qué sueño profesional NO te atreves a decir en voz alta?" },
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Dones Trader Reprimidos", time: "20 min", inst: "Responde en tu diario:\n\n1. ¿Qué talento de trading has minimizado?\n2. ¿A qué trader envidias? ¿Qué hace que tú también podrías hacer?\n3. ¿Has rechazado tu PROPIA forma de operar por seguir lo 'correcto'?\n4. ¿Qué tipo de trader serías sin miedo al juicio?" },
          { type: "meditation", icon: "🧘", title: "El Trader en Plenitud", time: "15 min", inst: "Este es un ejercicio de visualización. CIERRA LOS OJOS y sigue estos pasos:\n\nPaso 1 — VISUALIZA que estás sentado en tu estación de trading, pero esta vez eres la versión más poderosa de ti mismo. Operas desde tu MÁXIMO potencial: sin frenos, sin dudas, sin segundas adivinanzas.\n\nPaso 2 — OBSERVA en tu mente: ¿Qué trades tomas esta versión de ti? ¿Con qué convicción los ejecuta? ¿Cómo maneja las pérdidas? ¿Cómo se siente su cuerpo operando así?\n\nPaso 3 — SIENTE esa confianza por al menos 5 minutos. No es fantasía: es tu sombra dorada, el potencial que tu Saboteador ha mantenido reprimido.\n\nAl terminar, ESCRIBE en tu cuaderno: '¿Qué hace diferente mi versión en plenitud que yo no me estoy permitiendo hacer?' La respuesta es tu próximo paso de crecimiento como trader." },
          { type: "practice", icon: "📊", title: "Un Trade desde la Intuición", time: "Durante tu sesión", inst: "Durante tu sesión de trading de hoy, vas a tomar UN solo trade basado en tu intuición. Sigue estos pasos:\n\nPaso 1 — OBSERVA el mercado sin forzar un análisis. Espera hasta que algo te 'llame la atención' — un movimiento, un nivel, una sensación corporal de que 'ahí hay algo'.\n\nPaso 2 — COLOCA tu stop loss y gestiona el riesgo como siempre (esto NO es operar sin reglas, es operar con tu instinto + protección).\n\nPaso 3 — EJECUTA el trade y ESCRIBE inmediatamente en tu cuaderno:\n• ¿Qué sentía mi cuerpo justo antes de entrar? (tensión, calma, excitación)\n• ¿Qué vi que mi cabeza no podía explicar racionalmente?\n• ¿De dónde salió la decisión: de mi análisis, de mi miedo, o de algo más profundo?\n\nEl resultado del trade NO importa hoy. Lo que importa es darle espacio a tu sombra dorada: esa intuición de trader que has aprendido a silenciar." },
          { type: "reflection", icon: "🔍", title: "Permiso para Ganar", time: "5 min", inst: "Este ejercicio se hace EN VOZ ALTA. Busca un lugar privado donde nadie te escuche.\n\nPaso 1 — LEE estas 3 afirmaciones en voz alta, una por una:\n• 'Me doy permiso para ganar consistentemente.'\n• 'Me doy permiso para confiar en mi intuición.'\n• 'Me doy permiso para ser mejor de lo que mi familia esperaba de mí.'\n\nPaso 2 — IDENTIFICA cuál de las 3 frases te cuesta MÁS decir (la que sientes más incómoda, falsa o difícil de pronunciar). Esa frase revela tu sombra dorada más profunda — el permiso que aún no te has dado.\n\nPaso 3 — REPITE esa frase específica 7 veces en voz alta, cada vez con más convicción.\n\nESCRIBE en tu cuaderno cuál fue la frase más difícil y por qué crees que te cuesta. Esa respuesta vale oro para tu crecimiento." },
        ],
      },
    },
  },
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "practice", icon: "🎯", title: "Usar el Oro", time: "Durante el día", inst: "Elige tu 'defecto transmutado (transformado)' más poderoso. Hoy, úsalo conscientemente. Si transmutaste (transformaste) 'miedo' → 'prudencia inteligente': toma una decisión con precaución calculada, no parálisis. Siente la diferencia." },
          { type: "reflection", icon: "🔍", title: "El Oro Encontrado", time: "5 min", inst: "¿Qué descubriste al usar tu defecto transmutado (transformado)? Escribe la lección en UNA frase para siempre." },
        ],
      },
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Tabla de Transmutación Trader", time: "25 min", inst: "ESCRIBE en tu cuaderno una tabla con 3 columnas: DEFECTO → HABILIDAD OCULTA → CÓMO LO APLICO.\n\nPara cada defecto de trading que tengas, encuentra la habilidad positiva que esconde y escribe cómo usarla mañana:\n\n1. Impulsividad → Ejecución rápida cuando el setup es claro.\n   Aplicación: 'Mañana, si veo mi setup A perfectamente alineado, ejecuto sin dudar.'\n\n2. Miedo → Risk management intuitivo.\n   Aplicación: 'Mañana, usaré mi miedo como señal para revisar mi stop antes de entrar.'\n\n3. Codicia → Capacidad de dejar correr ganadores.\n   Aplicación: 'Mañana, si un trade va a mi favor, NO cierro temprano por ansiedad.'\n\n4. Perfeccionismo → Ojo para entradas precisas.\n   Aplicación: 'Mañana, confiaré en mi análisis detallado para encontrar mejores entradas.'\n\nAhora ESCRIBE tus propios defectos (mínimo 4) con la misma estructura. Para CADA uno responde: '¿Cómo convierto este defecto en una herramienta operativa mañana?'" },
          { type: "meditation", icon: "🧘", title: "Visualización Alquímica", time: "15 min", inst: "Este es un ejercicio de visualización guiada. CIERRA LOS OJOS y sigue estos pasos:\n\nPaso 1 — VISUALIZA frente a ti un caldero alquímico (un recipiente grande sobre fuego, como los que usaban los alquimistas para transformar metales).\n\nPaso 2 — PIENSA en tu peor defecto de trading (el que más daño te ha causado). VISUALIZA que lo colocas dentro del caldero. OBSERVA cómo el fuego lo envuelve y comienza a transformarlo.\n\nPaso 3 — OBSERVA qué sale del fuego: ¿en qué habilidad positiva se convirtió tu defecto? Dale forma, color y nombre a esa nueva habilidad.\n\nPaso 4 — REPITE el proceso con 2 defectos más.\n\nAl terminar, ESCRIBE en tu cuaderno:\n• Defecto 1 → Se convirtió en: ___\n• Defecto 2 → Se convirtió en: ___\n• Defecto 3 → Se convirtió en: ___\n\nEsta visualización reprograma tu mente para ver tus debilidades como materia prima de tu fortaleza." },
          { type: "practice", icon: "📊", title: "Operar con el Oro", time: "Durante tu sesión", inst: "Este ejercicio se practica durante tu sesión de trading de hoy.\n\nPaso 1 — ELIGE el defecto transmutado más poderoso de tu tabla de transmutación (el que hiciste en el ejercicio anterior).\n\nPaso 2 — ESCRIBE antes de abrir tu plataforma: 'Hoy voy a usar [mi defecto transformado] como herramienta. Concretamente voy a: ___'\n\nEjemplos de cómo aplicarlo:\n• Si transmutaste impulsividad → ejecución rápida: BUSCA un setup que requiera acción inmediata y ejecútalo con convicción total, sin dudar.\n• Si transmutaste miedo → radar de riesgo: PERMITE que el miedo te informe sobre posiciones que tienen riesgo excesivo y ajusta antes de entrar.\n• Si transmutaste codicia → capacidad de holdear: DEJA correr un trade ganador más allá de donde normalmente cerrarías por ansiedad.\n\nPaso 3 — Al cerrar la sesión, ESCRIBE: '¿Usé mi defecto transformado hoy? ¿Funcionó? ¿Qué aprendí?'\n\nHoy no operas desde tu debilidad — operas desde tu sombra dorada." },
          { type: "reflection", icon: "🔍", title: "Nueva Habilidad", time: "10 min", inst: "REFLEXIONA sobre tu experiencia de hoy operando con tu defecto transmutado y RESPONDE estas preguntas en tu cuaderno:\n\n1. ¿Tu defecto transmutado funcionó mejor de lo esperado, igual, o peor?\n\n2. ¿En qué momento específico de la sesión sentiste que estabas operando desde tu 'sombra dorada' (tu potencial oculto)?\n\n3. ¿Hubo algún momento donde el defecto ORIGINAL intentó regresar? ¿Qué hiciste?\n\nFinalmente, ESCRIBE la lección de hoy en UNA sola frase poderosa que puedas leer antes de cada sesión de trading.\n\nEjemplo: 'Mi impulsividad es mi velocidad — cuando el setup es claro, ejecuto sin miedo.'\n\nPEGA esta frase junto a tu pantalla de trading." },
        ],
      },
    },
  },
  // ═══ DAY 10 ═══
  {
    ...
    routes: {
      ...
      operador: {
        ...
        exercises: [
          { type: "journal", icon: "✍️", title: "Antes y Después del Trader", time: "20 min", inst: "ESCRIBE en tu cuaderno una comparación detallada de tu evolución en estos 10 días. Divide la página en 2 secciones:\n\nSECCIÓN 1 — MI TRADING HACE 10 DÍAS:\nESCRIBE con honestidad cómo eras antes de iniciar el reto. Responde cada pregunta:\n• ¿Cómo operaba? (impulsivo, con miedo, sin plan, etc.)\n• ¿Qué me controlaba sin que yo lo supiera? (emociones, creencias, patrones heredados)\n• ¿Cuál era mi peor patrón repetitivo?\n• ¿Qué sentía antes, durante y después de operar?\n\nSECCIÓN 2 — MI TRADING HOY:\nESCRIBE cómo operas ahora después de los 10 días. Responde cada pregunta:\n• ¿Cómo opero ahora? ¿Qué cambió concretamente?\n• ¿Qué herramientas integré? (Protocolo Pausa, Filtro Pre-Operación, respiración, etc.)\n• ¿Qué patrón logré romper o debilitar?\n• ¿Qué evidencia concreta tengo de mi cambio? (trades específicos, decisiones, momentos)\n\nESCRIBE al final: 'La prueba de que ya no soy el mismo es: ___'. Esta página es tu evidencia de transformación." },
          { type: "meditation", icon: "🧘", title: "Ceremonia de Cierre", time: "15 min", inst: "Esta es la visualización final del reto. CIERRA LOS OJOS y sigue estos pasos:\n\nPaso 1 — RESPIRA con la técnica 4-7-8 por 5 ciclos:\n• Inhala en 4 segundos.\n• Retén el aire durante 7 segundos.\n• Exhala lento durante 8 segundos.\n\nPaso 2 — VISUALIZA a tu Saboteador trader frente a ti. Después de 10 días de conocerlo, ya no es un enemigo. Es una parte de ti que intentaba protegerte.\n\nPaso 3 — EXTIENDE tu mano y estrecha la suya. DECLARA en voz alta o mentalmente con firmeza: 'Somos uno. Operamos y gestionamos desde la totalidad.'\n\nPaso 4 — ABRE los ojos lentamente, sintiendo la integración completa.\n\nAl terminar, ESCRIBE en tu cuaderno qué sentiste al hacer las paces con tu Saboteador. ¿Hubo resistencia? ¿Alivio? ¿Emoción?" },
          { type: "practice", icon: "📊", title: "El Trade de Individuación", time: "Durante tu sesión", inst: "Este es tu trade final del reto. Hoy operas tu mejor setup aplicando TODO lo que aprendiste. Sigue este ritual completo:\n\nPaso 1 — ANTES de abrir la plataforma:\n• ESCRIBE tu estado emocional: 'Me siento ___ porque ___'\n• LEE tu Carta al Miedo y tu frase de transmutación\n• RESPIRA con tu técnica de calma (4-7-8 o 5-5-7)\n\nPaso 2 — DURANTE la sesión:\n• APLICA el Filtro Pre-Operación en cada trade (¿análisis o Saboteador?)\n• RESPETA el Protocolo Pausa después de cualquier pérdida\n• OPERA desde tu sombra dorada (tu defecto transmutado como herramienta)\n\nPaso 3 — AL CERRAR la sesión, ESCRIBE:\n• ¿Seguí mi ritual completo? ¿En qué punto me salí del proceso?\n• ¿El resultado importa menos que la calidad del proceso?\n\nEl resultado del trade NO es lo que importa hoy — importa la calidad de tu proceso. Este es tu declaración como trader integrado." },
          { type: "reflection", icon: "🔍", title: "Manifiesto + Invitación", time: "15 min", inst: "ESCRIBE tu Manifiesto del Trader Integrado en primera persona. Es tu declaración de quién eres ahora como trader. Usa esta estructura:\n\n'Yo soy un trader que ___.\nYa no opero desde ___.\nAhora opero desde ___.\nMi Saboteador ya no me controla porque ___.\nMi mayor fortaleza es ___.\nMe comprometo a ___.'\n\nESCRIBE al menos media página con tus propias palabras. Hazlo personal y poderoso.\n\nFinalmente, PIENSA: ¿Qué trader específico que conoces necesita este reto? ¿Quién sigue atrapado en los mismos patrones que tú tenías hace 10 días?\n\nESCRIBE su nombre y COMPARTE el reto con esa persona AHORA. Tu transformación es la mejor prueba de que funciona." },
        ],
      },
    },
  },

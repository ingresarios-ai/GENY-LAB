...
export const DIAG_R: Record<string, {
  title: string;
  color: string;
  glow: string;
  message: string;
    ...
    routes: {
      novato: {
        ...
        exercises: [
          ...
          { type: "practice", icon: "🎯", title: "Mapa de Triggers", time: "15 min", inst: "3 columnas: TRIGGER → REACCIÓN → NECESIDAD OCULTA. Ej: 'Veo curso de trading → Lo descarto → Miedo a descubrir que no soy capaz'. Identifica 5 triggers." },
          { type: "reflection", icon: "🔍", title: "La Necesidad Secreta", time: "10 min", inst: "Tu Saboteador cumple una misión equivocada. Marca: □ Protegerme del fracaso □ Confirmar que 'no merezco' □ Mantener zona de confort □ Evitar el juicio □ Castigarme. La que marcaste es su lealtad invisible." },
        ],
      },
      operador: {

            ...
            >
              ...
              <div className="relative z-10 p-5 flex flex-col gap-4">
                ...
                <div>
                  ...
                  <h2 className="text-xl font-bold tracking-[0.08em] leading-tight mb-2 text-[#00D1FF]">{lesson.title}</h2>
              ...
              <motion.div key={lesson.id} ref={isCurrent ? desktopCurrentCardRef : null} initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: idx * 0.1 }} onClick={() => handleNodeClick(lesson)}
                ...
                <div className="relative z-10 p-6 h-full flex flex-col justify-between">
                  ...
                  <div className="mt-auto">
                    ...
                    <h2 className={`min-h-[60px] whitespace-pre-line line-clamp-2 text-2xl font-bold tracking-[0.08em] leading-tight mb-2 transition-colors duration-300 ${isCurrent ? 'text-[#00D1FF]' : completed ? 'text-white/90' : 'text-white/40'}`}>{lesson.title}</h2>
